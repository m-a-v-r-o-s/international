...
// createModel / updateModel used to live here. Car models moved to the fleet
// screen with the plates that belong to them; their actions moved with them,
// to src/app/(app)/admin/fleet/model-actions.ts, where the photo upload the
// form now does is next to the rest of the write.
