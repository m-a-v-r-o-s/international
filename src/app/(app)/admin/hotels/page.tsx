...
/**
 * A8 · Users & hotels — the hotels half.
 *
 ...
 * who is stationed there and who covers it. That list is the same
 * `hotel_reps` data the users screen writes, shown from the other side,
 * because "who can see this hotel's bookings" is the question the boss is
 * actually asking when he looks at a hotel.
 *
 * Client item 6 — the hotel list and rep assignments — has not arrived, and
 * nothing here invents one. This screen is how the boss enters it himself,
 * which is the point of building it before the pilot.
 */
